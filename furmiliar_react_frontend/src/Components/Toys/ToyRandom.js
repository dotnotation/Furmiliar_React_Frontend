...
export default function ToyRandom() {
    ...
    return (
        <div className='random-toy'>
            ...
            {toyOfTheDay ? <ToyRandomCard {...toyOfTheDay} /> : <span className='mx-auto px-4'>It seems like there are no highly rated toys today. Please let us know where your dog's favorite toys is.</span>}
